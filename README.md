...
**Altered Icons** is a collection of icons in SVG raw format. Created for use in design, web, or app projects. You have the option to choose between two icon types that best suit your needs, [chubby-line →](docs/catalog/chubby-line) or [flatter →](docs/catalog/flatter-line).
