...
All Pull Requests targeting **Chubby icons** must include a clear and structured description.
...
- [ ] Icons follow the style guide (`docs/guide/chubby/README.md`)
- [ ] Variant-specific rules were respected
- [ ] Geometry and smoothness rules were followed
- [ ] Spacing and legibility were verified at small sizes
- [ ] SVGs were optimized using the correct SVGO config  
- [ ] No unnecessary nodes, groups, or attributes remain
...
All Chubby icons **must be optimized before submission**. For this style and variant, optimization is handled using:

`tools/svgo/styles/chubby/line.config.js`

Run the optimization tooling as defined in the global CONTRIBUTING file.  

This configuration enforces:
- controlled path simplification
- preservation of stroke geometry
- consistent rounding and curve handling
...
The following SVG structure represents the **canonical format** for `chubby/line` icons.
